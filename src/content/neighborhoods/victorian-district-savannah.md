...
heroImage: "savannah"
demandDrivers:
  - "Walk-to-downtown location: the district borders Forsyth Park, so guests are minutes on foot from the squares, Bull Street, and the tourism core without paying the Landmark District premium"
  - "Architectural draw: blocks of ornate Victorian wood-frame homes attract travelers who specifically want character and a residential feel over a hotel"
  - "St. Patrick's Day and festival overflow: when the Landmark District fills, demand spreads directly into the adjacent Victorian District for Savannah's biggest weekends"
  - "Destination weddings: larger Victorian homes with porches and yards suit wedding parties and friend groups who want space near downtown venues"
  - "Year-round leisure tourism: tours, dining, and Forsyth Park keep the district's occupancy steady across seasons"
attractions:
...
faqs:
  - q: "How is the Victorian District different from the Landmark Historic District for STR owners?"
  ...
  - q: "What can I earn renting my Victorian District property on Airbnb?"
...
ATLStay manages Victorian District properties with that local context built in — pricing to Savannah's real demand calendar, presenting each home to the guests most likely to book it, and maintaining the kind of older housing stock that needs a hands-on local team. See [/resources/](/resources/) for a broader overview of Georgia short-term rental compliance.
