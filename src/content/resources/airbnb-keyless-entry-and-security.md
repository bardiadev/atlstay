...
| Stage | What happens |
|---|---|
| Booking confirmed | Unique code generated for that guest's check-in/checkout window |
| Check-in day | Code activates at stated check-in time |
| During stay | Guest uses their code; no other recent codes work |
| Checkout time | Code expires automatically — no action required |
| Next booking | New unique code generated; cycle repeats |
...
This is the operational standard ATLStay uses across managed properties — it's part of the [services](/services/) and [how it works](/how-it-works/) model because it removes an entire category of problems from day-to-day management.
...
For a sense of the overall operations layer that surrounds these systems, the [cleaning and turnover standards guide](/resources/airbnb-turnover-cleaning-standards-atlanta/) covers what professionally managed property condition looks like between guests.
