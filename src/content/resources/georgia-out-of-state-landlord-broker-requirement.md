---
title: "Georgia's Broker Rule for Out-of-State Landlords (HB 399)"
description: "What O.C.G.A. § 44-7-25 asks of non-resident owners of Georgia single-family and duplex rentals — who it covers and what employing a broker means."
category: "Regulations & Taxes"
publishDate: 2026-08-11
heroImage: "suburbHome"
faqs:
  - q: "Does Georgia require out-of-state landlords to hire a licensed broker?"
    a: "For a specific group, yes. O.C.G.A. § 44-7-25(a), created by HB 399, says that a landlord who is not a resident of Georgia and who owns or operates single-family or duplex residential rental properties in the state shall employ a broker licensed under Chapter 40 of Title 43. It does not apply to owners who live in Georgia, and on its face it names single-family and duplex property rather than every property type. This is general information, not legal advice — confirm how it applies to your ownership structure with a Georgia attorney."
  - q: "Who exactly does O.C.G.A. § 44-7-25 cover?"
...
If you own a rental house in metro Atlanta and you live somewhere else, a 2025 change to Georgia law is worth twenty minutes of your attention. House Bill 399 created a new code section, [O.C.G.A. § 44-7-25](https://gov.georgia.gov/document/2025-signed-legislation/hb-399/download), that tells non-resident owners of single-family and duplex rentals to put a licensed Georgia broker over the property.
...
*Source: [Signed text of HB 399, Office of the Governor of Georgia](https://gov.georgia.gov/document/2025-signed-legislation/hb-399/download)*
...
Whether § 44-7-25 reaches a property operated purely as short-term lodging is genuinely unsettled on the face of the text. The section lives in Georgia's landlord and tenant article and speaks of landlords, tenants, and residential rental property, while paragraph (11) expressly contemplates that a short-term guest agreement is *not* a lease or rental agreement. Those framings point in different directions and the statute does not reconcile them. If you own a Georgia short-term rental from out of state, ask a Georgia attorney rather than settle it from a summary — including this one. Our [Georgia short-term rental regulations guide](/resources/georgia-short-term-rental-regulations-guide/) covers the separate permitting and tax layers on those properties.
...
The prohibition on local rental registries is **not new**. The sentence saying local governments may not require registration of residential rental property, and may only investigate or inspect on probable cause, already appears in the [code text as it stood before 2025](https://codes.findlaw.com/ga/title-36-local-government/ga-code-sect-36-74-30/).
...
The enrolled Act contains no effective-date section — we checked, and its last section is only the standard repealer. Under [O.C.G.A. § 1-3-4(a)(1)](https://codes.findlaw.com/ga/title-1-general-provisions/ga-code-sect-1-3-4/), an Act approved on or after January 1 and before July 1 of a calendar year takes effect on July 1 of that year. Since HB 399 appears in the Governor's [2025 signed legislation](https://gov.georgia.gov/executive-action/legislation/signed-legislation/2025) library, the default rule points to July 1, 2025 whichever spring day the signature happened.
...
*Sources: [BillTrack50 — GA HB 399](https://www.billtrack50.com/billdetail/1828535); [FastDemocracy — GA HB 399 history](https://fastdemocracy.com/bill-search/ga/2025_26/bills/GAB00029300/); [FOX 5 Atlanta, May 15, 2025](https://www.fox5atlanta.com/news/gov-kemp-signs-120-bills-law-before-2025-deadline); [Atlanta Civic Circle, April 7, 2025](https://atlantaciviccircle.org/2025/04/07/georgia-bill-regulating-out-of-state-landlords-passes/)*

## What an Out-of-State Owner Should Actually Do Next

1. **Establish where you stand.** Are you a Georgia resident? Is the property single-family or duplex? Is title held personally or in an entity? Those three answers determine whether the section describes you at all.
2. **If an entity holds title, ask a Georgia attorney about residency.** This is the genuine open question in the statute and it is not one to guess at.
3. **Look at who manages the property today.** If it is you, a management company you control, or someone you employ full time, those are the arrangements paragraphs (7) and (8) covered — and they no longer apply to this group.
4. **If you already use a manager, confirm the licensing is documented.** Ask for the licensee of record and keep the written management agreement somewhere you can find it. If the brokerage sits outside Georgia, ask who their in-state person is.
5. **Keep short-term and long-term questions separate.** They run under different parts of the code, and an answer about one is not an answer about the other.
6. **Re-check periodically.** This section is new, we found no reported Georgia decision interpreting it, and the General Assembly returns every January.
...
In practice that is ordinary and unglamorous: a written management agreement, a documented licensee of record, real people in Atlanta answering maintenance calls, and a fee structure quoted up front and in writing before you sign anything. If you are weighing which way to run the property, our comparison of [short-term versus long-term returns in Atlanta](/resources/airbnb-vs-long-term-rental-atlanta/) and our [exit-strategy guide](/resources/short-term-rental-exit-strategy/) are the useful places to start. You can see the service itself on our [long-term rental management](/services/long-term-rental-management/) page, or [tenant placement](/services/tenant-placement/) if you only need the tenant found.
