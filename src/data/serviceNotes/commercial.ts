...
export const commercialNotes: ServiceNotes = {
  ...
  // ── Researched 2026-09-01 against primary sources.
  'multi-family-property-management:norcross': [
    `Norcross multi-family is older than the metro average and that is the operating reality, not a detail. Census figures for 2020-2024 count 7,846 housing units in the city, of which 2,041 — 26% — sit in structures of five units or more, rising to 2,610 on a two-or-more-units definition. The largest single construction cohort is 1980-1989 at 2,528 units, 32% of everything standing. A portfolio here is mostly forty-year-old building systems, which decides the capital plan long before it decides the rent roll.`,
    `The tenancy side is equally specific: 2,964 of 7,390 occupied homes are rented, 40.1%, at a median gross rent of $1,715. That is a working renter base beside the Peachtree Corners employer corridor rather than a transient one, which rewards renewal management over aggressive turn-and-reprice — every avoided turn on ageing stock is a unit turn that does not expose a forty-year-old system on a deadline.`,
    `New supply is being deliberately slowed, which matters to anyone holding existing units. In March 2026 Norcross council voted 3-2 to require a special use permit for multifamily and mixed-use development in the Community Mixed-Use and Buford Highway districts, with mandatory community engagement before an application is even considered, and split the old character area so larger-scale development is pushed toward Buford Highway rather than the historic downtown. Meanwhile the $46 million Walton Crossing redevelopment replaced roughly 25 units built sixty years ago with 166 mixed-income and senior units, completing in 2026. Existing well-run stock faces less new competition than a growth market of this size would normally imply.`,
  ],

  'investor-services:douglasville': [
    `Douglasville is a genuinely renter-heavy city inside a more conventional county, and that gap is the investment case. Census figures for 2020-2024 put 7,288 of the city's 14,104 occupied homes in renters' hands — 51.7% — against 33.1% for Douglas County as a whole. Median gross rent in the city is $1,582; median value of an owner-occupied home is $359,200, against $296,900 county-wide. An investor evaluating on county averages will misprice a city asset in both directions.`,
    `The competitive picture is better here than the headlines suggest. Across Georgia, investors own 629,355 single-family homes — 19.8% of the state's stock — but 79.2% of those are held by owners with ten properties or fewer, and large institutional owners accounted for just 2.3% of landlord purchase volume in the final quarter of 2025. Metro Atlanta is the exception rather than the rule at roughly 27.9% institutional ownership of single-family rentals, about four times the national figure. The counties where that concentration bites hardest are Gwinnett, Cobb, Fulton, DeKalb and Clayton; Douglas does not appear in the region's top tier.`,
    `Two things are worth watching before committing capital. Douglas County grew from 132,403 people in 2010 to 144,237 in 2020, an 8.9% decade — real growth, but not the explosive kind that carries a marginal purchase. And the regulatory weather is changing: Georgia's 2026 session saw a bipartisan attempt to cap large single-family-rental owners statewide, which passed the Senate before stalling on constitutional grounds. It did not become law, but a legislature that tried once tends to try again, and a strategy that only works at institutional scale is more exposed to that than one that does not.`,
  ],
