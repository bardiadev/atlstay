...
export const counties: County[] = [
  ...
  },
  {
    ...
    regulationsNote: "Cobb County adopted a short-term rental ordinance on 27 September 2022, effective 1 January 2023 — a certificate from the business license division, one per dwelling unit, a sworn statement that any homeowners association has been notified, and fines of $500, then $750, then revocation. Its own Applicability section binds only 'any owner of any property within the unincorporated areas of Cobb County', so it does not reach Marietta, Smyrna, Kennesaw or Acworth. Those cities set their own position and it is not uniform: Marietta had adopted no dedicated short-term rental ordinance as of its council's May 2026 discussion. We confirm the right path per address before listing.",
    faqs: [
      {
